...
def register_datasets_mixtures():
    ...
    video_chatgpt = Dataset(
        ...
        dataset_type="torch",
        data_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/VIDEO_CHATGPT/annotations.json",
        image_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/VIDEO_CHATGPT/videos",
    )
    ...
    sharegpt_video = Dataset(
        ...
        dataset_type="torch",
        data_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/SHAREGPT_VIDEO/annotations.json",
        image_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/SHAREGPT_VIDEO/videos",
    )
    ...
    sharegpt4v_sft = Dataset(
        ...
        dataset_type="torch",
        data_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/SHAREGPT4V_SFT/annotations.json",
        image_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/SHAREGPT4V_SFT/videos",
    )
    ...
    envdrop = Dataset(
        ...
        data_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/EnvDrop/annotations.json",
        image_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/EnvDrop/videos",
    ...
    scanqa = Dataset(
        dataset_name="scanqa",
        dataset_type="torch",
        data_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/ScanQA/annotations/ScanQA_v1.0_train_reformat.json",
        image_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/ScanQA/videos",
    ...
    r2r = Dataset(
        dataset_name="r2r",
        dataset_type="vlnce",
        data_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/R2R/annotations.json",
        image_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/R2R/train",
    ...
    rxr = Dataset(
        dataset_name="rxr",
        dataset_type="vlnce",
        data_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/RxR/annotations.json",
        image_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/RxR/train",
    ...
    human = Dataset(
        dataset_name="human",
        dataset_type="vlnce",
        data_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/Human/annotations.json",
        image_path="/mnt/dataset/NaVILA_Dataset/NaVILA_Dataset/NaVILA-Dataset/Human/raw_frames/",

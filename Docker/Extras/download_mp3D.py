...
## To download the relevant MatterPort3D (MP3D) Data for
## the "NaVILA" project, you should use the following flags to download:
## -o "/mnt/dataset/NaVILA_Dataset/data/datasets/scene_datasets" --task_data habitat
